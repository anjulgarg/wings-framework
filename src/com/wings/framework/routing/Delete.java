...
public class Delete {
	 ...
	 * that will respond to Delete requests.
	 ...
	 */
	public Delete( String route, String controller )
	{
		routeList.add(route);
	 ...
	 * <h5>Example :</h5>
	 * <p>
	 * new Delete( "/home", "controller", "com.app.HomeController@welcome" )
	 * </p>
	 * </P>
	 * <p>
	 * Here "com.app.HomeController" is the Class name and
	 ...
	 * @param String controllerName
	 */
	public Delete( String route, String type, String controller )
	{
	 ...
	 * middleware that will respond to Delete requests.
	 * The controller/middleware name defined should contain the complete 
	 * class name and the method that acts as the controller/middleware.
	 * <p>
	 * <h5>Example :</h5>
	 * <p>
	 * new Delete( "controller", new String[]{"/home", "/index"}, "com.app.HomeController@welcome" )
	 * </p>
	 * </P>
	 * <p>
	 * Here "com.app.HomeController" is the Class name and
	 ...
	 */
	public Delete( String type, String[] routes, String controller )
	{
		if( type.equalsIgnoreCase( "controller" ) )
